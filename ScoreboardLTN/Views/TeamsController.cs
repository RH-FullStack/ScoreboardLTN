...
namespace ScoreboardLTN.Views
{
    public class TeamsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Team.Include(t => t.Game);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Score,Time,GameId")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Score,Time,GameId")] Team team)
        {
            if (id != team.Id)
            {
                return NotFound();
