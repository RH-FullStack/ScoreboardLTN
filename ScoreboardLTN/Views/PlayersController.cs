...
namespace ScoreboardLTN.Views
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,GamerTag,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,GamerTag,TeamId")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
